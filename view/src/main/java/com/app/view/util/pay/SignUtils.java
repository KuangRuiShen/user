...
public class SignUtils {
    ...
    public static boolean checkParam(Map<String,String> params,String key){
        ...
        if(params.containsKey("sign")){
            ...
            SignUtils.buildPayParams(buf,params,false,false);
     ...
     * @return
     */
    public static void buildPayParams(StringBuilder sb,Map<String, String> payParams,boolean encoding,boolean appendNull){
        List<String> keys = new ArrayList<String>(payParams.keySet());
        Collections.sort(keys);
        for(String key : keys){
        	if(appendNull){
